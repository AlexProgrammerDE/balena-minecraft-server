...
If you want to use a different Minecraft Sever .jar, add a variable called "JAR_FILE" (without the quotes). The value should be the same as your custom .jar file.
